...
// which is useless for "what is on today". orderBy=startTime requires it.
...
// Create an event. `event` must already be in Google shape — the LLM produces
// it and validateEventShape checks it before we get here.
...
// that is hard to trace back; a missing summary silently creates a blank event.
